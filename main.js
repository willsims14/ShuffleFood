...
$("#shuffle-btn").on('click', function(event) {
    ...
    $.getJSON("values/food.json", function(restaurants, status){
        ...
        var random_rest_string =    `<h2 class="lead">${random_rest_obj.name}</h2>
                                    <p class="flow-text">${random_rest_obj.type}</p>
        ...
        if (random_rest_obj.menu_url != ""){
            ...
            if (random_rest_obj.menu_url_2 != ""){
                random_rest_string += `<br><a href="${random_rest_obj.menu_url_2}">View Other Menu</a>`;
            }
        }
        ...
        if(menu_link_string_1 != "" && menu_link_string_2 != ""){
            random_rest_string += `  <div class="row center">
                                    <img class="my_image col s6" src="${menu_link_string_1}"></a>
                                    <img class="my_image col s6" src="${menu_link_string_2}"></a>
                                    </div>`;

        }else if(menu_link_string_1 != ""){
            random_rest_string += `<img class="my_image col s6" src="${menu_link_string_1}"></a>`;
        }
